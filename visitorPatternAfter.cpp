...
//class Visitor; Definimos el forward
...
public:
	...
	virtual void accept(class Visitor*) = 0;  // aqui hacemos el forward directamente donde lo vamos a utilizar (Los dos son validos)
};
